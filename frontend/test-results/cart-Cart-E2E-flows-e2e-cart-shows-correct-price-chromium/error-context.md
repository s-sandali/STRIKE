...
- Name: cart.spec.ts >> Cart E2E flows >> e2e_cart_shows_correct_price
- Location: e2e\cart.spec.ts:114:3
...
Locator: locator('.cart-item-price')
Expected: "LKR 5,000.00"
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 10000ms
  - waiting for locator('.cart-item-price')
