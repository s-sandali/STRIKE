...
- Name: cart.spec.ts >> Cart E2E flows >> e2e_cart_page_shows_items
- Location: e2e\cart.spec.ts:99:3
...
Locator: locator('.cart-item-name')
Expected: "Test Sneaker"
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 10000ms
  - waiting for locator('.cart-item-name')
